...
class Vp_visits(scrapy.Spider):
    name = 'vice_president_visits'
    page_number = 1  # Initialize page_number

    def __init__(self):
        self.base_url = "https://www.mea.gov.in/vice-president-visits.htm"
        self.data = []
    ...
    def parse(self, response):
        ...
        next_button_disabled = response.css('input#ctl00_ContentPlaceHolder1_VicePresidentVisitsMap1_CustomPager1_ibtnMoveNext[disabled]').get() is not None
        ...
        if not next_button_disabled:
            ...
            yield FormRequest.from_response(
                ...
                callback=self.parse,
                formdata={
                    'ctl00$ContentPlaceHolder1$VicePresidentVisitsMap1$CustomPager1$ibtnMoveNext': 'Next',
    ...
    # Combine nested lists into a flat list 
        ...
        folder_path = r"C:\Users\putta\OneDrive\Desktop\My_Projects\Project\Vice_president_visits_output.csv"
